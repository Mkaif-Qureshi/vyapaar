    ...
    return (
        <div className="min-h-screen bg-white text-black p-6">
            ...
            <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
                ...
                <button type="button" class="text-white bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-2 focus:outline-none focus:ring-green-200 dark:focus:ring-green-400 font-medium rounded-lg text-sm px-2.5 py-2.5 text-center me-2 mb-2 ml-auto">Generate Quotation ✨ </button>
            </form>
        </div>
    );
};
